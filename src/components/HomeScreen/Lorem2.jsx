...
const Lorem2 = () => {
  const partner = [
    ...
    },
    {
      ...
      role: "Peternak",
      picture:
        "https://zoomerscorner.com/wp-content/uploads/2021/03/Layer-5-2-1024x576.jpg",
      description:
        "Harum iusto exercitationem assumenda quas nostrum perspiciatis quos iste sit reprehenderit, libero quae aperiam sapiente delectus, porro tempore minus repellendus ratione distinctio!",
      facebookURL: "#link",
      twitterURL: "#link",
    ...
    },
    {
      ...
      role: "Investor",
      picture:
        "https://pict.sindonews.net/dyn/850/pena/news/2021/11/30/158/614379/drama-adaptasi-webtoon-ini-bakal-dibintangi-yook-sungjae-uhu.jpg",
      description:
        "Harum iusto exercitationem assumenda quas nostrum perspiciatis quos iste sit reprehenderit, libero quae aperiam sapiente delectus, porro tempore minus repellendus ratione distinctio!",
      facebookURL: "#link",
      twitterURL: "#link",
  ...
  return (
    <div className="relative mt-12 mx-auto py-10 w-full max-w-screen bg-white text-gray-700">
      {/* :TITLE CONTAINER */}
      ...
      <div className="mx-auto px-4 w-full max-w-7xl grid grid-cols-2 gap-y-4 sm:gap-y-10">
        {/* :PICTURES CONTAINER */}
        ...
        <div className="col-span-full lg:col-span-1 mx-auto lg:mx-2 max-w-xl flex flex-col justify-center space-y-4">
          ...
          <div className="mb-4 inline-flex space-x-4">
            {/* Facebook */}
            <a
              href={partner[member].facebookURL}
            ...
            {/* Twitter */}
            <a
              href={partner[member].twitterURL}
              className="text-gray-600 hover:text-red-600"
            >
              <svg
                className="w-6 h-6"
            ...
            {/* Linkedin */}
            <a
              href={partner[member].linkedinURL}
              className="text-gray-600 hover:text-red-600"
            >
              <svg
                className="w-6 h-6"
            ...
            {/* Youtube */}
            <a
              href={partner[member].youtubeURL}
              className="text-gray-600 hover:text-red-600"
            >
              <svg
                className="w-6 h-6"
