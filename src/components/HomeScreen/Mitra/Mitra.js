...
const Mitra = () => {
  ...
  return (
    <section id="mitra" className="bg-white">
      <div className="container px-6 py-10 mx-auto">
        ...
        <Slider ref={setSliderRef} {...sliderSettings}>
          {mitraSlider.map((item, index) => (
            <div
              key={index}
              className="flex flex-col justify-center text-center items-center gap-3 p-8 transition-colors duration-300 transform mx-auto cursor-pointer group hover:bg-blue-600 rounded-xl"
            >
