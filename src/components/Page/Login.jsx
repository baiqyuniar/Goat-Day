...
const Login = () => {
  ...
  return (
    <div className="relative w-full py-20 px-5 flex flex-col items-center bg-gray-800 font-body">
      ...
      {/* :BACKGROUND */}
      <div className="absolute top-0 w-full h-full bg-gradient-to-r from-sky-600 to-cyan-400 opacity-50" />
      {/* :MAIN CONTAINER */}
      <div className="relative z-10 max-w-5xl w-full md:w-3/4 grid grid-cols-7 overflow-hidden rounded-lg shadow-xl">
        {/* ::Image */}
        <div className="hidden md:block md:col-span-2 relative bg-gray-200 bg-opacity-75 border-t border-transparent" />
        {/* ::Options */}
        ...
        >
          ...
          >
            ...
            <form action="" className="py-10 w-full">
              ...
              <div className="mt-10 w-full">
                <Button type="submit" bgColor="bg-green-600 bg-opacity-70">
                  Log in
                </Button>
              </div>
            </form>
          ...
          >
            ...
            <form action="" className="py-10 w-full">
              ...
              {/* Login Submit Button */}
              <div className="mt-10 w-full">
                <Button type="submit" bgColor="bg-blue-600 bg-opacity-70">
                  Register
                </Button>
              </div>
            </form>
